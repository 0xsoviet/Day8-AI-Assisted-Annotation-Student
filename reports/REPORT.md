...
Ba frame minh họa từ `SELECTION.md` vòng 1 dựa trên `outputs/selection_round1.csv`: frame_0182.jpg (hạng 1, score=0.959, U=0.918, A=1.000) đứng đầu vì toàn bộ 18 box đều mơ hồ — cold start không tự tin về bất kỳ xe nào trong cảnh mật độ cao; frame_0326.jpg (hạng 4, score=0.916, A=1.000, 39 box) là frame đông xe nhất trong lô 12 ảnh; frame_0331.jpg (hạng 5, score=0.915, U=0.831, 47 box, 18 mơ hồ) có số box và số xe mơ hồ cao nhất lô — khớp với round1_diff.md: model đề xuất 20 box nhưng tôi thêm 22 FN mới và xóa 3 FP cột đèn đường. Đối chiếu với frame_0187.jpg (hạng 10, score=0.900, BLIND_SCAN: 27 xe đếm bằng mắt trước khi xem pre-label): model đề xuất 14 box nhưng sau sửa có 26, A=0.944 — xác nhận điểm A cao tương quan trực tiếp với FN thực tế.
